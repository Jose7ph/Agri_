...
fun <T> RollPicker(
    ...
    val animatedOffset = remember { Animatable(0f) }.apply {
        val index = idx ?: list.indexOf(value)
    ...
    DisposableEffect(Unit) {
        onValueChange(idx ?: list.indexOf(value), value)
        onDispose { }
    }
    Layout(modifier = modifier.draggable(orientation = Orientation.Vertical,
            ...
            coroutineScope.launch {
                val endValue = animatedOffset.fling(initialVelocity = velocity,
                    ...
                    adjustTarget = { target ->
                        ...
                        val coercedAnchors = listOf(-columnHeightPx, 0f, columnHeightPx)
                ...
                onValueChange(list.indexOf(result), result)
                        ...
                        when {
                            off == -3 && coercedAnimatedOffset > half -> {
                                ...
                                Box(
                                    ...
                                    item(index, list.elementAt(index))
                                }
                            }
...
fun Label(
    ...
    Box(
        ...
        AutoScrollingText(text = text, modifier = Modifier.align(Alignment.Center), color = color)
    }
}
